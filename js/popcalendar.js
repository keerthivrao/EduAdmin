...
//  Modified (Very Little) by Rakesh Gangula according to application on 5/07/06
    ...
    */
	...
	if (dom)
	{
		...
		document.write ("<div onclick='bShow=true' id='calendar' class='div-style'><table border='0' width="+((showWeekNumber==1)?250:220)+" class='table-style'><tr class='title-background-style'><td width='100%'><table border='0' width='"+((showWeekNumber==1)?268:228)+"'><tr><td align='center' class='title-style'><B><span id='caption'></span></B></td><td align=right></td></tr></table></td></tr><tr><td class='body-style'><span id='content'></span></td></tr>")
	...
	function constructCalendar () {
		...
		sHTML =	"<table border='0' cellspacing=0 cellpadding=0 class='myday-style'><tr>"

		if (showWeekNumber==1)
		{
			sHTML += "<td width=16><b>" + weekString + "</b></td><td width=1 rowspan=7 class='weeknumber-div-style'><img src='"+imgDir+"divider.gif' width=1></td>"
		}

		for	(i=0; i<7; i++)	{
			sHTML += "<td width='26' align='center'><B>"+dayName[i]+"</B></td>"
		}
		sHTML +="</tr><tr>"
		
		if (showWeekNumber==1)
		{
			sHTML += "<td align=center>" + WeekNbr(startDate) + "&nbsp;</td>"
		}
